...
<?php 
	...
	echo '<tr> <th style="text-align:right;">Username</th><td>' . $row['username'] . '</td><td><a href="editUsername1.php">Edit</a></td></tr>';
	echo '<tr><th style="text-align:right;">Password</th><td>******</td><td><a href="editPassword1.php">Edit</a></td></tr> ';
	echo '<tr><th style="text-align:right;">Email Address</th><td>' . $row['emailAddress'] . '</td><td><a href="editEmail1.php">Edit</a></td></tr>';
	// close table
	echo "</table>";
	...
	echo '<tr><td></td><td><a href="editInfo1.php">Edit</a></td></tr>';
	echo '<tr><td></td><td><a href="deleteAccount1.php?userID='.$row1['userID'].'">Terminate Account</a></td></tr>';
	// close table
	echo "</table>";
